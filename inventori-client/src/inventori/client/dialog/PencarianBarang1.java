 ...
 * @author ayu
 */
public class PencarianBarang1 extends javax.swing.JDialog {
    ...
    public PencarianBarang1(BarangDao barangDao,
    ...
    public void update(PembelianDetail pd, Gudang g){
        gudang=g;
        ...
        try {
            ...
            if(!bar.isEmpty()){
                ...
                if(ambilData!=null){
                    ...
                    manajemen = manajementDao.getRofSafety(ambilData);
                    txtBarang.setText(barang.getKd_brg());
                    if (manajemen!=null) {
                        int jml = (int) manajemen.getRop_safety();
                        txtJumlah.setText(String.valueOf(jml));
                    } else {
                    }
                }
            }
